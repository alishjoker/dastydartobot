...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"ممنون http://line.me/ti/p/~joker.alish",
    "lang":"JP",
    "comment":"ممنون http://line.me/ti/p/~joker.alish",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                if msg.toType == 2:
                    ...
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done dasyartobot")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done dasyartobot")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done dasyartobot")
                    else:
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Selamat datang di dasyartobot Family Room")
